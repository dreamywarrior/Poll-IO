<?php
    ...
    $row="";
    $sql3 = "SELECT * from polldata WHERE pollname = '$pollname' AND username = '$username'";
    ...
    $sql5 = "UPDATE polldata SET val1 = '$val1',val2 = '$val2',val3 = '$val3',val4 = '$val4',val5 = '$val5' WHERE pollname = '$pollname' AND username = '$username'";
