...
<html>
    <head>
    <button class= "but" onclick = "location.href = 'optionmenu.php'">Go Back To menu</button>
    </head>
<?php
    include("config.php");
    ...
    $row="";
    $sql4 = "SELECT * from polldata WHERE pollname = '$pollname' AND username = '$username'";
    $res4 = mysqli_query($conn, $sql4); 
    if($res4){
        //echo "data selected successfully<br>";
        while($row = mysqli_fetch_assoc($res4)){
        //echo "username: " . $row["username"]. "<br>pollname: " . $row["pollname"]. "<br>description: " . $row["description"]. "<br>";
...
?>
    ...
    <body>
    <div class = "display">
            <div class = 'header'><?php echo $pollname ?></div><br>
            <div class = 'content'>Author : <?php echo $username ?><br><?php echo $content ?> </div><br>
            <input type = "radio" name = "a" id = "opt1" value = "<?php echo $w1 ?>"><span id = "op1"><?php echo $w1 ?></span>
            ...
            <input type = "button" onclick = "count()" class = "but" value = "click here to confirm your vote">
            <input type = "radio" style = "visibility:hidden" name = "a" id = "sub">
            <form id = "myform" method = "POST" action = "publicresult.php" style = "visibility:hidden">
                ...
                <input type = "text" id = "userr" name = "userr" value = "<?php echo $userr ?>">
                ...
                <input type = "submit" style = "visibility: hidden" id = "submitbutton">
            </form>
        </div>
    <script>
            var t = "";
